var StarSystem = (function () {
    ...
    StarSystem.genStarSubstrings = {
        ...
        p2: ["tow", "dac", "lit", "scha", "ite", "is", "ic", "plex", "bid", "orta", "terra", "schild", "pen", "zen", "fort", "and", "key", "rut", "ei", "ear", "son", "ent", "ice", "katz", "hun", "heim", "enes", "burg", "feld", "har", "ar", "am", "as", "a", "koshka", "dom", "stin", "anz", "ko", "ja", "el", "tor", "stra", "gorod", "ae", "canis", "roma", "gallia", "nia", "don", "ton", "belga", "via", "null", "ra", "marit", "senex", "bus", "fir", "feuer", "kon", "kos", "ros", "lex", "loch", "tus", "domus", "ser", "ius", "ium", "il", "um", "us", "itz", "ca", "anov", "sk", "stein", "ev", "ine", "tol"],
