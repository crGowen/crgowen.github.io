...
var _this = this;
var short = {
    h: function () { return document.head; },
    ...
    generator: function (appendTo, html, args) {
        var htmlRes = "";
    ...
    fillWithHtml: function (appendTo, fetchUrl) { return __awaiter(_this, void 0, void 0, function () {
        var response, result, parser, dom;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, fetch(fetchUrl)];
                case 1:
                    response = _a.sent();
